...
func ProvideK8sClient(cfg *config.Config, logger *zap.Logger) (service.K8sClientInterface, error) {
...
func RegisterHooks(lc fx.Lifecycle, client service.K8sClientInterface, logger *zap.Logger) {
	lc.Append(fx.Hook{
